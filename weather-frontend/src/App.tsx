...
const App: React.FC = () => {
    ...
    const weatherDates = weatherData.map(day => format(new Date(day.date), 'dd.MM.yyyy'));
    const maxTemps = weatherData.map(day => day.max_temp);
    const minTemps = weatherData.map(day => day.min_temp);
